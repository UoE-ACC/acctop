...
def display_cpu_usage_in_columns():
    ...
    print(core_label_width, core_number_width, core_joined_label_width, max_bar_length)

    # Total column width (bar + percentage + spacing)
    column_width = core_joined_label_width + max_bar_length + 10  # Extra space for spacing and formatting
